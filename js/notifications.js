...
class NotificationManager {
  ...
  showMotivationalQuote() {
    const quotes = [
      'Nie poddawaj się - ból jest tymczasowy!',
      'Dzisiaj możesz zrobić coś, czego nie mogłeś wczoraj',
      'Sukces to suma małych wysiłków powtarzanych dzień po dniu',
      'Twoje ciało może wszystko - to twój umysł musisz przekonać',
      'Nie zatrzymuj się, gdy jesteś zmęczony - zatrzymaj się, gdy skończysz',
      'Jedyna zła sesja treningowa to ta, której nie zrobiłeś',
      'Bądź silniejszy niż twoje wymówki'
    ];

    const randomQuote = quotes[Math.floor(Math.random() * quotes.length)];
    this.showNotification('💪 Motywacja', {
      body: randomQuote,
      icon: './icons/icon-192x192.png',
      badge: './icons/icon-72x72.png',
      tag: 'motivation'
